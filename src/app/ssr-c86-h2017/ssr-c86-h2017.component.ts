...
@Component({
  selector: 'app-ssr-c86-h2017',
  templateUrl: './ssr-c86-h2017.component.html',
  styleUrls: ['./ssr-c86-h2017.component.css']
})
export class SsrC86H2017Component implements OnInit {
  public id: string;
