...
@Component({
  selector: 'app-portdataterminal',
  templateUrl: './portdataterminal.component.html',
  styleUrls: ['./portdataterminal.component.css']
})
export class PortdataterminalComponent implements OnInit {
