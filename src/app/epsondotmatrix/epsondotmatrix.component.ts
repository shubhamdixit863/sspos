...
@Component({
  selector: 'app-epsondotmatrix',
  templateUrl: './epsondotmatrix.component.html',
  styleUrls: ['./epsondotmatrix.component.css']
})
export class EpsondotmatrixComponent implements OnInit {
