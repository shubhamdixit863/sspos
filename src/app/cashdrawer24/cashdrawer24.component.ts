...
@Component({
  selector: 'app-cashdrawer24',
  templateUrl: './cashdrawer24.component.html',
  styleUrls: ['./cashdrawer24.component.css']
})
export class Cashdrawer24Component implements OnInit {
  public id: string;
